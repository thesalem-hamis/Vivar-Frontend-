// src/components/about/AboutWhatWeDo.tsx
...
const services = [
  {
    ...
    description:
      "Buying and selling premium homes across Lagos, Abuja, and Port Harcourt. Every listing verified, every client guided from search to signature.",
  },
  {
    id: "02",
    title: "Investment Consultancy",
    description:
      "Identifying high-yield acquisition targets, assessing rental income potential, and supporting portfolio growth with expert market analysis.",
  },
  {
    id: "03",
    title: "Off-Plan & Project Sales",
    description:
      "Representing premium development projects at the pre-construction and under-construction stage — early access, best pricing, maximum appreciation potential.",
  },
  {
    id: "04",
    title: "Expert Valuations & Appraisals",
    description:
      "Professional valuations for mortgage applications, insurance, mergers, refinancing, litigation, and estate planning. Government and institutional-grade reporting.",
  },
  {
    id: "05",
    title: "Diaspora Property Advisory",
    description:
      "End-to-end support for Nigerians abroad — remote property search, virtual viewings, legal verification, and trusted management after purchase.",
  },
];

// Fixed variants — use `ease` as a tuple with `as const`
  ...
  return (
    <section className="w-full min-h-screen bg-[#0A1F24] text-white px-6 py-16 md:px-16 md:py-24 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center overflow-hidden">
      ...
      >
        ...
        >
          We are a full-service real estate firm specialising in premium residential, investment, and advisory
          services across Nigeria's most strategic locations.
        </motion.p>
                ...
                <div className="flex items-center space-x-4 md:space-x-6">
                  <span
                    className={`text-xs md:text-sm font-mono font-medium transition-colors duration-300 ${
                      isOpen ? "text-[#4ECDC4]" : "text-white/50"
                    }`}
                  >
                    {service.id}
                  </span>
