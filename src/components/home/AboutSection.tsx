...
//   return (
//     <div ref={targetRef} className="relative min-h-screen md:h-[240vh] bg-[#f9fafb]">
...
//                 We don’t just match clients to properties. We protect your investment from first conversation to final signature.
//               </p>
//             </div>
...
//         <div className="flex md:hidden flex-col gap-16 mt-12 mb-6">
          
//           {/* Main Pull-Quote Hook (Light Weight & Italic) */}
//           <div className="border-l border-[#0E292F]/40 pl-5 max-w-md flex flex-col gap-1">
//             <span className="text-[9px] font-light italic tracking-[0.2em] text-[#3D7188] uppercase block">
//               Perspective
//             </span>
//             <p className="text-base font-light italic tracking-tight text-[#0E292F] leading-relaxed">
//               We don’t just match clients to properties. We protect your investment from first conversation to final signature.
//             </p>
//           </div>

//           {/* Clean typography blocks (Left-aligned layout) */}
//           <div className="flex flex-col gap-12">
//             {pieces.map((item, idx) => (
//               <div key={idx} className="flex flex-col gap-2.5 border-t border-black/[0.05] pt-6 items-start text-left">
//                 <span className="text-3xl font-light font-serif text-[#1D3F48]/30 block leading-none">
//                   {item.id}
//                 </span>
//                 <h3 className="text-xs font-bold tracking-[0.12em] text-[#0E292F] uppercase">
//                   {item.title}
//                 </h3>
