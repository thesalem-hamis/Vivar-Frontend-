...
export default function BestCard({ item }: BestCardProps) {
  ...
  return (
    ...
    >
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-t from-[#0E292F]/95 via-[#0E292F]/60 to-transparent mix-blend-multiply transition-opacity duration-300 group-hover:opacity-90" />
      ...
      <div className="absolute bottom-0 inset-x-0 p-5 sm:p-6 flex flex-col gap-1 z-10 text-left">
        ...
        <div className="flex items-center justify-between mt-2 pt-3 border-t border-white/10">
          ...
          <div
            className="w-7 h-7 rounded-[6px] border border-white/30 flex items-center justify-center bg-white/10
