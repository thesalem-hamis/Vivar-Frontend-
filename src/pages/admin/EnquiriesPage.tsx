...
import { Trash2, Loader2, MessageSquare, Phone, Tag } from "lucide-react";
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0 space-y-1.5">
                    <div className="flex flex-wrap items-center gap-3">
                      ...
                      {enq.property_type && (
                        <span className="inline-flex items-center gap-1 text-[11px] font-semibold px-2 py-0.5 rounded-full bg-[#0E292F]/8 text-[#0E292F]">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/30 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm p-6">
            ...
            <p className="text-sm text-neutral-500 mb-5">
              Enquiry from <strong>{deleteTarget.name}</strong> will be
              permanently removed.
            </p>
